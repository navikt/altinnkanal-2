...
fun onPremProducerConfig(kafkaProp: Environment.KafkaProducer) = mutableMapOf<String, Any>(
    ...
    SaslConfigs.SASL_JAAS_CONFIG to "org.apache.kafka.common.security.plain.PlainLoginModule required username=\"${kafkaProp.username}\" password=\"${kafkaProp.password}\";",
